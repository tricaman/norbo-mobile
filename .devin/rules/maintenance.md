...
- A new screen or navigation route is added
- A store, service, or data flow changes
- A new Zustand store or TanStack Query key is introduced
- MMKV key conventions change

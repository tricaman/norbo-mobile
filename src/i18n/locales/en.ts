const en = {
  ...
  tools: {
    ...
    foodPlantToxicity: {
      ...
      notes: {
        ...
        avocadoBird: "Avocado (persin) is potentially lethal to birds.",
        caffeine: "Caffeine is toxic to birds' hearts.",
        saltBird: "Salty foods: even small amounts are dangerous.",
        fruitPits: "The flesh is safe; seeds and pits contain cyanogens.",
        alcohol: "Alcohol is toxic even in tiny amounts.",
        rawBeans: "Raw/dry beans contain toxic hemagglutinins.",
        ptfe: "Fumes from overheated non-stick (PTFE) pans are lethal to birds.",
        millet: "Millet is safe: great as a treat.",
        buttercup: "Buttercup is toxic to tortoises.",
        foxglove: "Foxglove contains cardiotoxic glycosides.",
        daffodil: "Daffodil is toxic, especially the bulb.",
        ivy: "Ivy causes gastrointestinal upset.",
        avocado: "Avocado (persin) is toxic to many reptiles.",
        azalea: "Azalea and rhododendron contain grayanotoxins.",
        lilyValley: "Lily of the valley is cardiotoxic.",
        euphorbia: "Euphorbia latex is irritating and toxic.",
        rhubarb: "Rhubarb leaves are rich in oxalic acid.",
        spinachOxalate: "Spinach oxalates bind calcium: occasional only.",
        icebergLettuce: "Iceberg lettuce is nutrient-poor: avoid as a staple.",
        dandelion: "Dandelion is an excellent food for tortoises.",
        hibiscus: "Hibiscus flowers and leaves are safe and well liked.",
        plantain: "Plantain is a safe herb for tortoises.",
      },
    },
    bodyConditionScore: {
    ...
    bird: {
      species: {
        "finch-canary": "finch / canary",
        "budgie-parakeet": "budgie / parakeet",
        "cockatiel-lovebird": "cockatiel / lovebird",
        "medium-parrot": "medium parrot",
        "large-parrot": "large parrot",
        generic: "other bird",
      },
    },
    birdCageSize: {
      count: "number of birds",
      dimensions: "minimum dimensions (W×D×H)",
      barSpacing: "bar spacing",
      disclaimer: "indicative values, not a substitute for your avian vet.",
      notes: {
        perches: "natural perches of varying diameter.",
        flight: "favour width and horizontal flight over height.",
        outOfCage: "allow daily free flight outside the cage.",
        zinc: "avoid galvanized cages or lead paint (toxic metals).",
        macawMore:
          "large macaws and cockatoos need much bigger spaces or aviaries.",
        speciesVary: "needs vary a lot: check for your species.",
      },
    },
    birdFoodRation: {
      weight: "weight",
      dryFood: "pellets / seeds",
      freshVeg: "fresh vegetables",
      diet: "diet basis",
      weightHint: "typical weight for this group: {{min}}–{{max}} g",
      disclaimer: "indicative values, not a substitute for your avian vet.",
      dietKind: {
        seedBased: "quality seed mix + vegetables",
        seedOrPellet: "seeds and/or pellets + vegetables",
        pelletBased: "formulated pellets + vegetables",
        checkSpecies: "check for the species",
      },
      notes: {
        pelletShare: "for parrots, pellets should be 60–70% of the diet.",
        treatLimit: "oily seeds and fruit as treats, under 10%.",
        guardValues:
          "lories, mynas and other species have special diets: ask your avian vet.",
        noAvocado: "never avocado, chocolate or salty foods.",
      },
    },
    birdEnvironmentGuide: {
      selectProfile: "species group",
      temperature: "temperature",
      humidity: "humidity",
      ...
      disclaimer: "indicative values, not a substitute for your avian vet.",
      hazard: {
        ptfe: "fumes from overheated non-stick pans (PTFE/Teflon): lethal.",
        aerosols: "sprays, scented candles and smoke irritate the airways.",
        drafts: "drafts and temperature swings (windows, air conditioners).",
        nightFrights: "cockatiels suffer night frights: use a dim night light.",
        heavyMetals: "zinc and lead (cages, toys): toxic if chewed.",
        mirrorsWindows: "glass and mirrors: collision risk during free flight.",
      },
    },
    snakeFeedingGuide: {
      species: {
        ...
        boa: "boa",
        "king-milk": "king / milk snake",
        garter: "garter snake",
        hognose: "hognose",
        generic: "other snake",
      },
      ageBand: { HATCHLING: "hatchling", JUVENILE: "juvenile", ADULT: "adult" },
      age: "age",
      weight: "weight",
      preyType: "prey type",
      preySize: "prey size",
      preyWeight: "indicative prey weight",
      interval: "feeding interval",
      intervalUnit: "days",
      prey: {
        pinkyMouse: "pinky mouse",
        fuzzyHopperMouse: "fuzzy/hopper mouse",
        adultMouse: "adult mouse",
        hopperMouseRatPup: "hopper mouse or rat pup",
        adultMouseSmallRat: "adult mouse or small rat",
        mediumRat: "medium rat",
        mediumLargeRat: "medium-large rat",
        wormsFishStrips: "earthworms and fish strips",
        wormsFishPinky: "earthworms, fish or pinkies",
        wormsFishAdultPinky: "earthworms, fish or mice",
        sizeAppropriate: "prey sized to the body",
      },
      notes: {
        girthRodent: "prey ≈ the body's width at its widest point (1–1.15×).",
        garterDiet: "varied diet: earthworms, fish, occasional rodents.",
        garterThiaminase: "avoid thiaminase-rich fish (e.g. goldfish).",
        thawed: "prefer thawed prey, never live without supervision.",
        noHandling48h: "do not handle for 48 hours after a meal.",
        ballPythonFasting:
          "seasonal fasts are common: see your vet if it loses weight.",
        slowMetabolism: "slow metabolism: do not overfeed.",
        hognoseScenting: "may need scented prey.",
      },
      disclaimer: "indicative values, not a substitute for your vet.",
    },
    turtleTankCalculator: {
      species: {
        ...
        generic: "other aquatic turtle",
      },
      shellLength: "shell length",
      count: "number of turtles",
      tankVolume: "minimum tank volume",
      waterDepth: "minimum water depth",
      waterTemp: "water temperature",
      baskingTemp: "basking area",
      uvb: "UVB lamp",
      tortoiseHint: "for tortoises see the reptile environment guide.",
      disclaimer: "indicative values, not a substitute for your vet.",
      notes: {
        uvbRequired: "UVB needed 10–12 hours a day.",
        filtration: "filter rated for 2–3 times the volume.",
        baskingDock: "a dry basking area always accessible.",
        muskShallow: "poor swimmer: shallower water and grips to surface.",
        mapWaterQuality: "very sensitive to water quality.",
      },
    },
    amphibianEnvironmentGuide: {
      ...
      water: "water",
      tank: "tank / terrarium",
      disclaimer: "indicative values, not a substitute for an exotics vet.",
    },
    farm: {
      species: {
        "cow-lactating": "cow (lactating)",
        "cow-dry": "cow (dry)",
        calf: "calf",
        pig: "pig",
        goat: "goat",
        sheep: "sheep",
        "chicken-flock": "poultry",
        horse: "horse",
        donkey: "donkey",
        cow: "cow",
        alpaca: "alpaca / llama",
        generic: "other animal",
      },
    },
    chickenCoopCalculator: {
      ...
      standard: "standard",
      heavy: "heavy",
      floor: "coop floor area",
      run: "outdoor run",
      nestBoxes: "nest boxes",
      roost: "roost length",
      disclaimer: "indicative values for backyard keeping.",
      notes: {
        minimums: "these are minimums: more space is always better.",
        ventilation: "ensure draft-free ventilation and predator protection.",
      },
    },
    livestockWaterNeeds: {
      weight: "weight",
      headCount: "number of animals",
      birdCount: "number of birds",
      result: "daily requirement",
      perDay: "L/day",
      disclaimer: "indicative range, not a substitute for a vet or agronomist.",
      notes: {
        heat: "in hot weather the requirement rises a lot.",
        lactation: "lactating animals drink much more.",
        clean: "fresh, clean water always available.",
      },
    },
    forageRation: {
      weight: "weight",
      currentStock: "forage stock",
      dailyRange: "forage per day",
      daysLeft: "days of autonomy",
      days: "days",
      reorderDate: "reorder date",
      reminderTitle: "Reorder forage for {{name}}",
      disclaimer:
        "indicative values, not a substitute for a vet or agronomist.",
      notes: {
        dryMatter: "dry-matter basis: fresh forage weighs more.",
        donkeyStraw: "donkeys: high-fibre, low-calorie forage (straw mix).",
        horseFibre: "never below 1.5% of body weight in long fibre.",
      },
    },
    horseWeightEstimator: {
      ...
      howToMeasure:
        "girth just behind the elbow; length from the point of the shoulder to the point of the buttock.",
      result: "estimated weight",
      tip: "use this weight in the water and forage tools.",
      disclaimer:
        "estimate for adult horses (Carroll & Huntington). a weight tape or scale is more accurate.",
    },
    aquariumHeaterSize: {
      tankLiters: "tank volume",
      roomTemp: "room temperature",
      targetTemp: "target temperature",
      volumeHint:
        "calculate the volume with the aquarium volume tool and enter it here.",
      delta: "temperature rise",
      result: "recommended heater",
      split: "better with two heaters",
      splitNote: "two smaller heaters heat more evenly and add redundancy.",
      disclaimer: "indicative sizing; always use a separate thermometer.",
    },
    places: {
      kind: {
        DOG_PARK: "dog park",
        DOG_BEACH: "dog beach",
        DOG_FRIENDLY_VENUE: "dog-friendly venue",
        DOG_GREEN_AREA: "green area",
        DOG_TRAIL: "trail",
      ...
      addPlace: {
        ...
        submit: "submit",
        submitted: "thanks! your place will appear after review",
        duplicate: "a similar place already exists nearby",
        limit: "daily submission limit reached, try tomorrow",
        moderationNote: "submissions are reviewed before appearing on the map.",
      },
    },
  },
  ...
  careKnowledge: {
    reptile: {
      ...
      hermannTortoise: "Hermann's tortoise",
      greekTortoise: "Greek tortoise",
      crestedGecko: "crested gecko",
      veiledChameleon: "veiled chameleon",
      greenIguana: "green iguana",
      blueTongueSkink: "blue-tongued skink",
      notes: {
        uvbRequired: "UVB needed 10–12 hours a day.",
        uvbLow: "low-intensity UVB optional but recommended.",
        brumation:
          "winter brumation for healthy adults: research it well first.",
        brumationVet: "some subspecies should not brumate: ask your vet.",
        outdoorAccess: "outdoor access in summer is very beneficial.",
        heatSensitive: "above 28 °C it is in danger: never use heat rocks.",
        mistingCycle: "evening misting, dry during the day.",
        ventilation: "ventilated (screen) terrarium, never a closed aquarium.",
        nightDrop: "a night-time temperature drop is necessary.",
        dripWater: "drinks only droplets: dripper or misting.",
        adultSize: "as an adult it needs very large spaces.",
        subspeciesHumidity: "correct humidity depends on the subspecies.",
      },
    },
    amphibian: {
      axolotl: "axolotl",
      pacmanFrog: "pacman frog",
      whitesTreeFrog: "White's tree frog",
      redEyedTreeFrog: "red-eyed tree frog",
      fireBelliedNewt: "fire-bellied newt",
      tigerSalamander: "tiger salamander",
      generic: "amphibian (generic)",
      notes: {
        dechlorinated: "always use dechlorinated water (water conditioner).",
        noDistilled: "never distilled or pure RO water.",
        gentleFlow: "gentle filter flow.",
        coolWater: "above 20 °C it is at risk: cool down in summer.",
        shallowDish: "a shallow water dish always present.",
        mistDaily: "mist every day.",
        nightDrop: "a slight night-time temperature drop.",
        landArea: "a land area for resting.",
        burrow: "deep substrate for burrowing.",
      },
      tank: {
        axolotl: "min 60 L for one adult (80 cm tank).",
        pacmanFrog: "min 45×45 cm footprint for one adult.",
        whitesTreeFrog: "vertical terrarium min 45×45×60 cm.",
        redEyedTreeFrog: "vertical terrarium min 45×45×60 cm.",
        fireBelliedNewt: "min 40 L, about 70% water and 30% land.",
        tigerSalamander: "min 60×40 cm footprint, deep substrate.",
        generic: "depends on the species: ask an exotics vet.",
      },
    },
  },
  ...
  badges: {
    title: "badges",
    entrySubtitle: "your milestones",
    empty: "no badges yet",
    emptySubtitle: "your milestones will show up here",
    locked: "locked",
    currentTier: "current tier",
    nextTier: "next tier",
    maxTier: "top tier reached",
    progress: "{{current}} / {{target}} {{unit}}",
    requirement: "needs {{value}} {{unit}}",
    howToUnlock: "how to earn it",
    rarity: {
      COMMON: "common",
      RARE: "rare",
      EPIC: "epic",
  ...
  settings: {
    ...
    dataDeletion: "data & account deletion",
    support: "support",
  ...
  notifications: {
    ...
    achievementsSubtitle: "when you unlock a new badge tier",
  ...
  eventForm: {
    ...
    booklet: "booklet",
    addToBooklet: "add to booklet",
    addToBookletSubtitle: "record this event in the health booklet",
    ...
    parasiteDetails: "treatment details",
    productNamePlaceholder: "product name (optional)",
    treatmentType: "treatment type (optional)",
    treatmentType_INTERNAL: "internal",
    treatmentType_EXTERNAL: "external",
    treatmentType_BOTH: "both",
    medicationDetails: "medication details",
    medicineNamePlaceholder: "medicine name (optional)",
  },
  weightForm: {
    dateLabel: "date",
    weightLabel: "weight",
  ...
  reminderForm: {
    ...
    saveEdit: "save changes",
    repeat: "repeats",
    repeat_NONE: "one-time",
    repeat_MONTHLY: "every month",
    repeat_YEARLY: "every year",
    everyNMonths_one: "every month",
    everyNMonths_other: "every {{count}} months",
  },
  reminderDetail: {
    due: "due",
    statusLabel: "status",
  ...
  petDetail: {
    ...
    booklet: {
      identitySection: "identity details",
      registrySection: "health registry",
      edit: "edit",
      fill: "fill in",
      identityEmpty: "add microchip, passport and other booklet details",
      identityEmptyHint: "tap to fill in the booklet",
      registryEmpty: "tagged vaccinations and treatments will appear here",
      saveSuccess: "booklet saved",
      editTitle: "edit booklet",
      placeholder: "optional",
      allergiesPlaceholder: "separate with a comma",
      vetSection: "reference vet",
      insuranceSection: "insurance",
      healthSection: "health data",
      fields: {
        microchipNumber: "microchip number",
        microchipImplantedAt: "microchip implant date",
        microchipLocation: "microchip location",
        tattooNumber: "tattoo number",
        passportNumber: "passport number",
        registrationNumber: "registry number",

...
import type { ExpensePeriod } from "@/types/owner-expense.types";
...
/**
 * PeriodChips — segmented selector for the active expense window.
 * Active chip uses surface + border + bold text; inactive ones are flat.
 */

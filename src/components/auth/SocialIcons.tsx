...
// Monochrome Apple logo. Used only by the web-OAuth fallback button (Android /
// non-iOS); on iOS the native AppleAuthenticationButton renders its own glyph.
// `color` defaults to the current text colour so it adapts to the theme.
